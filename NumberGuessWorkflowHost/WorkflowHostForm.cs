...
namespace NumberGuessWorkflowHost
{
    public partial class WorkflowHostForm : Form
    {
        ...
        const string connectionString = "Data Source=.;Initial Catalog=WF45GettingStartedTutorial;User ID=sa;Password=123456";
        ...
        private void ListPersistedWorkflows()
        {
            ...
            {
                string localCmd = "Select [InstanceId] from [System.Activities.DurableInstancing].[Instances] Order By [CreationTime]";
